...
- [ ] Decide next Nach JSON set after Isaiah, likely `Yirmiyahu`
...
- [ ] Refine drawer support for Vayikra, Bamidbar, Devarim, Joshua, Judges, Samuel, Kings, and Isaiah after UI review
