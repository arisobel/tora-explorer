...
- [ ] Estender as traduções de conteúdo a mais parashiot/livros (próximos candidatos: Noach, restante de Gênesis; decidir ordem e se haverá assistência por LLM no editor)
