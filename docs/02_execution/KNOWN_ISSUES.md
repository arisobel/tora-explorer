...
**Symptom:** `data/timeline_groups.json` now includes Chumash groups plus Kings/Isaiah/Jeremiah First Temple and Exile pilots, but it is still manually maintained.
